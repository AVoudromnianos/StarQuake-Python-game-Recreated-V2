import pygame
import random
from room import Room1, Room2, Room3, Room4, Room5, Room6, Room7, Room8, Room9, Room10, Room11, Room12, Room13, Room14, Room15
...
Enemy_img_list = ["blue_monster.png", "yellow_monster.png", "green_monster.png", "red_monster.png"]
...
sb = pygame.image.load('score_board.png')
screen.blit(sb, (0, 0))
...
while loop:
    ...
    for event in pygame.event.get():
        ...
        if stay_right:
            player.image = pygame.image.load("player_right.png").convert()
            player.image.set_colorkey(BLACK)
        else:
            player.image = pygame.image.load("player_left.png").convert()
            player.image.set_colorkey(BLACK)
